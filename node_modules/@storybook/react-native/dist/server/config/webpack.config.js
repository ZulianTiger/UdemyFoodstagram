...
const getConfig = options => {
  ...
  const entriesMeta = {
    manager: {
      headHtmlSnippet: (0, _server.getManagerHeadHtml)(options.configDir, process.env)
    }
  };
  return {
    mode: 'development',
    ...
    }), new _webpack.default.HotModuleReplacementPlugin(), new _caseSensitivePathsWebpackPlugin.default(), new _WatchMissingNodeModulesPlugin.default(_utils.nodeModulesPaths), new _webpack.default.DefinePlugin(environment), new _dotenvWebpack.default({
      silent: true
    })],
    module: {
      rules: [{
